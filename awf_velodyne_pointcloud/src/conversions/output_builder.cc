...
OutputBuilder::OutputBuilder(size_t output_max_points_num, const VelodyneScan & scan_msg,
  ...
  if (xyzircaedt_activated_) {
    ...
    offsets_xyzircaedt_.x_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "x")].offset;
    offsets_xyzircaedt_.y_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "y")].offset;
    offsets_xyzircaedt_.z_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "z")].offset;
    offsets_xyzircaedt_.intensity_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "intensity")].offset;
    offsets_xyzircaedt_.channel_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "channel")].offset;
    offsets_xyzircaedt_.azimuth_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "azimuth")].offset;
    offsets_xyzircaedt_.elevation_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "elevation")].offset;
    offsets_xyzircaedt_.distance_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "distance")].offset;
    offsets_xyzircaedt_.return_type_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "return_type")].offset;
    offsets_xyzircaedt_.time_stamp_offset = output_xyzircaedt_->fields[pcl::getFieldIndex(*output_xyziradt_, "time_stamp")].offset;
  }
...
void OutputBuilder::addPoint(
  ...
  last_azimuth = azimuth;
    ...
    */
    ...
    PointXYZIRCAEDT *point = (PointXYZIRCAEDT *) &output_xyziradt_->data[output_xyzircaedt_data_size_];
    point->x = x;
    point->y = y;
    point->z = z;
    ...
    output_xyzircaedt_->row_step += output_xyziradt_->point_step;
  }
